...
const M2run2 = new Cards("Run!", '1.13', ' ', false)
const M2fight3 = new Cards("Fight!", '1.2', ' ', false)
// deaths ↓
...
let game = [
    ...
    [
        ...
        // 2 ↓
        ["Chose your weapon!", M2optionTwo1, M2optionTwo2],
        // 3 ↓
        ["You swiftly kill the zergs with a few blows because they can’t hear where you are.", M2next4],
        // 4 ↓
        ["You encounter a large rock that needs to be moved for you to get past.", M2optionFour1, M2optionFour2],
        // 5 ↓
        [" With the help of your team you guys are able to get the rock out of the way. A few moments later a bigger version of the bat zergs comes flying at you.", M2optionFive1, M2optionFive2],
        // 6 ↓
        ["You get knocked on the floor.", M2optionSix1, M2optionSix2],
        // 7 ↓
        ["Hitting its head, the shot disorients the zerg and now you have a chance to draw your sword and strike.", M2optionSevenLive, M2optionSevenDeath],
        // 8 ↓
        ["The zerg misses you and hits its head on the wall, making it wobble in the air.", M2optionEightLive, M2optionEightDeath],
        // 9 ↓
        ["You hit the zerg and kill with one strike.", M2next10],
        // 10 ↓
        ["You come across a room containing a large collection of bat zergs that look to be in their infancy. Along with the bat zergs you find the third piece.", M2optionTen1, M2optionTen2],
        // 11 ↓
        ["You quickly slice them and the older bat zergs barely notice your actions because of how quiet your sword is.", M2next12],
        // 12 ↓
        // Add third piece
